...
from cs336_basics.train import data_loader, save_checkpoint, load_checkpoint
from cs336_basics.modules import Linear, Embedding, RMSNorm, SwiGLU, RoPE, softmax, dot_product_attention, \
    CausalMultiHeadedSelfAttention, TransformerBlock, TransformerLM, SiLU
...
def run_multihead_self_attention(
    ...
    """
    mha_layer = CausalMultiHeadedSelfAttention(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    # x (... seq_len d_model) -> RoPE (... seq_len d_model) -> MHA (... seq_len d_v)
    mha_layer = CausalMultiHeadedSelfAttention(d_model, num_heads, rope_theta=theta, max_seq_len=max_seq_len)
